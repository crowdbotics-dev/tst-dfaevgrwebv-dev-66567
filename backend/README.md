...
## Project Structure
    ...
    ├── tst_dfaevgrwebv_dev_66567  # Django project configurations
...
1. Clone this repo and `cd tst_dfaevgrwebv_dev_66567`
...
2. Clone this repo and `cd tst_dfaevgrwebv_dev_66567`
